namespace LibraryManagementSystem.Migrations
{
    ...
    public partial class InitialModelAndAddProfileAndBookAndCategoryTables : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        CoverImageName = c.String(),
                        BooksCtegoryId = c.Int(nullable: false),
                        BooksCategory_Id = c.Int(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.BooksCategories", t => t.BooksCategory_Id)
                .Index(t => t.BooksCategory_Id);
